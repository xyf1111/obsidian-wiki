...
- [[concepts/概念 16 - 技术选型方法论|概念 16 - 技术选型方法论]] — *更新于 08-26*
- [[concepts/概念 17 - 先设计再编码（详细设计）|概念 17 - 先设计再编码（详细设计）]] — *更新于 08-26*
- [[learning/职场工作技巧|职场工作技巧]] — *更新于 08-26*
- [[network/网络 01 - 协议基础|网络 01 - 协议基础]] — *更新于 08-25*
- [[concepts/概念 15 - 团队开发七大雷区|概念 15 - 团队开发七大雷区]] — *更新于 08-25*
...
| 分类 | 内容 |
|------|------|
| 🧪 [[concepts/]] | 概念 01-19 · 常见 Bug 原因分析 · 解决 Bug 的流程套路 · 简易转译器 · 快速建站全栈技术栈 · 悲观编程与代码优化习惯 · 正则表达式学习路线 · 计算机基础学习路线 · 设计模式学习路线 · 软件工程学习路线 · 状态机概念与实践 · 原码反码补码详解 · 设计模式实战案例 · 离线桌面软件实现思路 · 硬编码的危害与避免 · 团队开发七大雷区 · 技术选型方法论 · 先设计再编码（详细设计） · 后端接口开发避坑（校验·软删除·防误触） · 大厂项目研发流程 |
