---
title: "Go 底层原理 04 - 垃圾收集器GC"
date: 2021-11-09
tags: [mysql]
source: "https://xyf1111.github.io/go-garbage-collector/"
aliases:
  - "Go 底层原理 04 - 垃圾收集器GC"
---
...
> 原文：[https://xyf1111.github.io/go-garbage-collector/](https://xyf1111.github.io/go-garbage-collector/)
...
![内存管理的组件](https://xyf1111.github.io/images/memory-management-component.png)
*内存管理的组件*
...
![标记清除的标记阶段](https://xyf1111.github.io/images/mark-sweep-mark-phase.png)
*标记清除的标记阶段*
...
![标记清除的清除阶段](https://xyf1111.github.io/images/mark-sweep-mark-phase2.png)
*标记清除的清除阶段*
...
![三色的对象](https://xyf1111.github.io/images/tri-color-objects.png)
*三色的对象*
...
![三色标记垃圾收集器的执行过程](https://xyf1111.github.io/images/tri-color-mark-sweep.png)
*三色标记垃圾收集器的执行过程*
...
![三色标记后的堆](https://xyf1111.github.io/images/tri-color-mark-sweep-after-mark-phase.png)
*三色标记后的堆*
...
![三色标记与用户程序](https://xyf1111.github.io/images/tri-color-mark-sweep-and-mutator.png)
*三色标记与用户程序*
...
![三色不变性](https://xyf1111.github.io/images/strong-weak-tricolor-invariant.png)
*三色不变性*
...
![Dijkstra插入写屏障](https://xyf1111.github.io/images/dijkstra-insert-write-barrier.png)
*Dijkstra插入写屏障*
...
![Yuasa删除写屏障](https://xyf1111.github.io/images/yuasa-delete-write-barrier.png)
*Yuasa删除写屏障*
...
![垃圾收集与暂停程序](https://xyf1111.github.io/images/stop-the-world-collector.png)
*垃圾收集与暂停程序*
...
![增量垃圾收集器](https://xyf1111.github.io/images/incremental-collector.png)
*增量垃圾收集器*
...
![并发垃圾收集器](https://xyf1111.github.io/images/concurrent-collector.png)
*并发垃圾收集器*
...
![语言的并发收集](https://xyf1111.github.io/images/golang-concurrent-collector.png)
*语言的并发收集*
...
![STW垃圾收集器的垃圾收集时间](https://xyf1111.github.io/images/stop-the-world-garbage-collector-heap.png)
*STW垃圾收集器的垃圾收集时间*
...
![并发收集器的堆内存](https://xyf1111.github.io/images/concurrent-garbage-collector-heap.png)
*并发收集器的堆内存*
...
![垃圾收集的多个阶段](https://xyf1111.github.io/images/garbage-collector-phaes.png)
*垃圾收集的多个阶段*
...
![垃圾收集的触发](https://xyf1111.github.io/images/garbage-collector-trigger.png)
*垃圾收集的触发*
...
![处理器与后台标记任务](https://xyf1111.github.io/images/p-and-bg-mark-worker.png)
*处理器与后台标记任务*
...
![主机核数与垃圾收集任务模式](https://xyf1111.github.io/images/cpu-number-and-gc-mark-worker-mode.png)
*主机核数与垃圾收集任务模式*
...
![垃圾收集器工作池](https://xyf1111.github.io/images/gc-work-pool.png)
*垃圾收集器工作池*
...
![全局任务与本地任务](https://xyf1111.github.io/images/global-work-and-local-work.png)
*全局任务与本地任务*
...
![辅助标记的动态平衡](https://xyf1111.github.io/images/gc-mutator-assist.png)
*辅助标记的动态平衡*
...
![全局信用与本地信用](https://xyf1111.github.io/images/global-credit-and-assist-bytes.png)
*全局信用与本地信用*
